...
# 답변 버튼 배치
answer_E_button = tkinter.Button(q1_frame, text="새로운 사람들을 만나고 친해질\n생각에 설렌다.", bd=0, background = "#C3E7FA", activebackground = "#C3E7FA", activeforeground = "#FFFFFF", font = font_main, command=q1_E)
answer_I_button = tkinter.Button(q1_frame, text="대학에는 어떤 사람들이 있을지\n걱정되고 떨린다.", bd=0, background = "#C3E7FA", activebackground = "#C3E7FA", activeforeground = "#FFFFFF", font = font_main, command=q1_I)
...
# 답변 버튼 배치
answer_F_button = tkinter.Button(q2_frame, text="내가 정한 메뉴를 동기들이 좋아하지\n않을 수 있으니, 나는 아무거나\n먹어도 상관 없다.", font = font_main, bd=0, background = "#C3E7FA", activebackground = "#C3E7FA", activeforeground = "#FFFFFF",  command=q2_F)
answer_T_button = tkinter.Button(q2_frame, text="내가 먹고 싶은 메뉴가 이미 있다.\n적절히 조율해서 빠르게 결정한다.", bd=0, background = "#C3E7FA", activebackground = "#C3E7FA", activeforeground = "#FFFFFF", font = font_main, command=q2_T)
...
# 답변 버튼 배치
answer_S_button = tkinter.Button(q3_frame, text="분명 전에 배웠던 내용일 것이다.\n천천히 기억을 되짚어본다.", bd=0, background = "#C3E7FA", activebackground = "#C3E7FA", activeforeground = "#FFFFFF", font = font_main, command=q3_S)
answer_N_button = tkinter.Button(q3_frame, text="기억이 잘 나지 않더라도, 어떻게든\n해결될 것이다. 생각나는 해결\n방법을 시도해본다.",font = font_main, bd=0, background = "#C3E7FA", activebackground = "#C3E7FA", activeforeground = "#FFFFFF", command=q3_N)
...
# 답변 버튼 배치
answer_I_button = tkinter.Button(q4_frame, text="공부는 역시 도서관이 제일이야.\n조용한 열람실에서 공부한다.", bd=0, background = "#C3E7FA", activebackground = "#C3E7FA", activeforeground = "#FFFFFF", font = font_main, command=q4_I)
answer_E_button = tkinter.Button(q4_frame, text="다른 친구들이랑 공부 약속을 잡으면\n좀 하겠지? 스터디 모임을 찾는다.", bd=0, background = "#C3E7FA", activebackground = "#C3E7FA", activeforeground = "#FFFFFF",font = font_main, command=q4_E)
...
# 답변 버튼 배치
answer_P_button = tkinter.Button(q5_frame, text="과제? 그런 게 있었어?\n친구에게 급하게 물어본다.", bd=0, background = "#C3E7FA", activebackground = "#C3E7FA", activeforeground = "#FFFFFF", font = font_main, command=q5_P)
answer_J_button = tkinter.Button(q5_frame, text="이미 다 끝냈지! 뿌듯한 마음으로\n과제를 제출한다.", bd=0, background = "#C3E7FA", activebackground = "#C3E7FA", activeforeground = "#FFFFFF", font = font_main, command=q5_J)
...
# 답변 버튼 배치
answer_N_button = tkinter.Button(q6_frame, text="만약 내가 초콜릿을 몰래 두고 갔는데\n하필 그걸 들켜버리는 거?\n상상의 나래를 펼친다.", font = font_main, bd=0, background = "#C3E7FA", activebackground = "#C3E7FA", activeforeground = "#FFFFFF", command=q6_N)
answer_S_button = tkinter.Button(q6_frame, text="당연히 들키면 안 되지! 안 들키도록\n최대한 열심히 해보자.\n현실적으로 이야기한다.",font = font_main, bd=0, background = "#C3E7FA", activebackground = "#C3E7FA", activeforeground = "#FFFFFF", command=q6_S)
...
# 답변 버튼 배치
answer_T_button = tkinter.Button(q7_frame, text="친구에게 솔직하게 말하고\n고쳐달라고 이야기한다.", bd=0, background = "#C3E7FA", activebackground = "#C3E7FA", activeforeground = "#FFFFFF", font = font_main, command=q7_T)
answer_F_button = tkinter.Button(q7_frame, text="내 지적으로 친구도\n기분 나쁘진 않을까? 고민한다.", bd=0, background = "#C3E7FA", activebackground = "#C3E7FA", activeforeground = "#FFFFFF", font = font_main, command=q7_F)
...
# 답변 버튼 배치
answer_J_button = tkinter.Button(q8_frame, text="공부는 중요하니까 미루면 안 된다.\n일단 차근차근 공부 계획을 세우고,\n목표가 끝나면 놀아야지!", bd=0, background = "#C3E7FA", activebackground = "#C3E7FA", activeforeground = "#FFFFFF", font = font_main, command=q8_J)
answer_P_button = tkinter.Button(q8_frame, text="별로 어려운 시험도 아니고\n시험 전날에 바짝 하면 충분할 것 같다.\n일단 놀자!",font = font_main, bd=0, background = "#C3E7FA", activebackground = "#C3E7FA", activeforeground = "#FFFFFF", command=q8_P)
...
# 답변 버튼 배치
answer_S_button = tkinter.Button(q9_frame, text="생각보다 어려워 보이고\n도전하고 싶은 마음이 별로 없다.", bd=0, background = "#C3E7FA", activebackground = "#C3E7FA", activeforeground = "#FFFFFF", font = font_main, command=q9_S)
answer_N_button = tkinter.Button(q9_frame, text="내 진로에 관련 없는 일이라도\n뭔가 해보고 싶고 도전하고 싶다.", bd=0, background = "#C3E7FA", activebackground = "#C3E7FA", activeforeground = "#FFFFFF", font = font_main, command=q9_N)
...
# 답변 버튼 배치
answer_T_button = tkinter.Button(q10_frame, text="토론에서 어떤 부분이 잘못되었는지\n생각하고 다음에는 이길 수 있도록 \n계획을 짠다.", bd=0, background = "#C3E7FA", activebackground = "#C3E7FA", activeforeground = "#FFFFFF", font = font_main, command=q10_T)
answer_F_button = tkinter.Button(q10_frame, text="일단 같이 토론한 친구들에게\n‘괜찮아, 다음엔 더 잘할 수 있을거야.’\n라며 위로한다.", bd=0, background = "#C3E7FA", activebackground = "#C3E7FA", activeforeground = "#FFFFFF",font = font_main, command=q10_F)
...
# 답변 버튼 배치
answer_I_button = tkinter.Button(q11_frame, text="아무리 친해도 잘 말하지 못하겠다.\n마음 속에만 고이 간직한다.", bd=0, background = "#C3E7FA", activebackground = "#C3E7FA", activeforeground = "#FFFFFF", font = font_main, command=q11_I)
answer_E_button = tkinter.Button(q11_frame, text="힘들었던 일들을 주변 사람들에게\n잘 털어놓는 편이다. 이야기를\n하고나면 마음이 좀 편해진다.", bd=0, background = "#C3E7FA", activebackground = "#C3E7FA", activeforeground = "#FFFFFF", font = font_main, command=q11_E)
...
# 답변 버튼 배치
answer_P_button = tkinter.Button(q12_frame, text="트랙 신청 기간 마지막 날에 선택해도\n괜찮으니까, 그 전까지 충분히\n고민해보고 결정한다.", bd=0, background = "#C3E7FA", activebackground = "#C3E7FA", activeforeground = "#FFFFFF", font = font_main, command=q12_P)
answer_J_button = tkinter.Button(q12_frame, text="내가 진짜 하고 싶은 건 뭘까?\n나에게 잘 맞는 건 뭘까? 머릿속에\n떠오르는 대로 바로 결정한다.", bd=0, background = "#C3E7FA", activebackground = "#C3E7FA", activeforeground = "#FFFFFF", font = font_main, command=q12_J)
